<div class="clearfix whendoyou">
	...
	<div class="holder">
		<div class="grid_12 omega boxes">
			<ul>
				<li id="broadcast"><a href="javascript:void(0)" id="broadlink" class="open active">Websites</a><div class="box" style="display:block;"><?php get_template_part('content', 'broadcast'); ?></div></li>
